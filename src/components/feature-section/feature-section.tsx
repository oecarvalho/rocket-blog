    ...
    return (
        <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pb-8 pt-8 md:py-10">
            <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
                <span className="body-tag uppercase text-blue-200 bg-blue-400 px-2 py-1 w-fit rounded-sm">Simples</span>
            ...
            <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
                <span className="body-tag uppercase text-blue-200 bg-blue-400 px-2 py-1 w-fit rounded-sm">Prático</span>
                <h2 className="text-gray-100 text-heading-lg">
            ...
            <div className="col-span-full flex flex-col gap-2">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
                    <div className="flex flex-col gap-4 ">
                        <span className="body-tag uppercase text-blue-200 bg-blue-400 px-2 py-1 w-fit rounded-sm">personalizável</span>
                        <h2 className="text-gray-100 text-heading-lg">
                    ...
                    <div className="flex flex-col items-center justify-center w-full">
                        ...
                        <Button asChild className="w-full gap-2 rounded-full hidden mt-4 md:mt-auto md:hidden">
                            <Link href='/criar-loja'>
                                Criar loja grátis
                                <ArrowRight />
                            </Link>
